...
public class Header implements Compilable {
    ...
    public Header(Element element) {
        this(
                element.getChildText("Description", CamsConstants.CAM_NAMESPACE),
                element.getChildText("Owner", CamsConstants.CAM_NAMESPACE),
                element.getChildText("Version", CamsConstants.CAM_NAMESPACE)
        );
    }
